...
public interface StagedTool extends Tool {
     ...
     * @return the values for {@link #call}, in its order; never {@code null} — a call taking
     *         nothing takes an empty array
     * @throws Exception if the text cannot be read — carried openly, decided by the caller
     */
    Object[] resolveArguments(String arguments, ChatContext context) throws Exception;
